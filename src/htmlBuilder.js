...
const generateGithubLink = () => `
  <a href="https://github.com/ChiamZhang/sublink-worker" target="_blank" rel="noopener noreferrer" class="github-link">
...
const generateCardHeader = () => `
  <div class="card-header text-center">
    <h1 class="display-4 mb-0">Chiam Conversion Tool</h1>
  </div>
`;
